...
#    Updated: 2023/12/08 13:36:56 by pdrago           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC=$(SRCDIR)/end_game.c $(SRCDIR)/attack.c $(SRCDIR)/enemy.c $(SRCDIR)/lettering.c $(UTILSDIR)/ft_itoa.c $(SRCDIR)/hooks.c $(SRCDIR)/map.c $(SRCDIR)/map_checkers.c $(SRCDIR)/map_utils.c $(SRCDIR)/movements.c $(SRCDIR)/path_checker.c $(SRCDIR)/renders.c $(SRCDIR)/so_long.c $(SRCDIR)/sprites.c $(SRCDIR)/validations.c $(UTILSDIR)/ft_printf.c $(UTILSDIR)/ft_putchar_fd.c $(UTILSDIR)/ft_putstr_fd.c $(UTILSDIR)/ft_strchr.c $(UTILSDIR)/ft_strlen.c $(UTILSDIR)/ft_strnstr.c $(GNLDIR)/get_next_line.c  $(GNLDIR)/get_next_line_utils.c
RED=\e[31m
GREEN=\e[32m
ENDCOLOR=\e[0m
MAPDIR = maps
